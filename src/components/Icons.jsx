...
// Centralized SVG icons — no external image dependencies
export const Icons = {
  sun: (props) => (
  ...
  brain: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 2a5 5 0 0 0-4.9 6 3.5 3.5 0 0 0-1.1 6.8 4 4 0 0 0 6 3.2v2h0" />
      <path d="M12 2a5 5 0 0 1 4.9 6 3.5 3.5 0 0 1 1.1 6.8 4 4 0 0 1-6 3.2v2h0" />
      <line x1="12" y1="18" x2="12" y2="22" />
    </svg>
  ),
...
// Helper to get social icon by key
export function getSocialIcon(iconKey) {
  return Icons[iconKey] || Icons.externalLink;
}
